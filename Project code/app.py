...
def chatbot():
    if request.method == 'POST':
        ...
        if 'name' not in data:
            ...
            reply = "What’s your employment type?(Salaried/Self-Employed/FreeLancer)" if is_valid_number(user_input) else "Please enter a valid age."
            ...
            reply = "What type of loan are you applying for?(Personal/Home/Vehicle/Business/Education/Gold)"
...
def generate_pdf():
    ...
    y -= 30
    p.drawString(100,y,f"Loan Eligibility:{result}")
